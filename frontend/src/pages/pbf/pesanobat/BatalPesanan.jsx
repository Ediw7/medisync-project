  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/pbf/pesanan/${id}/request-batalkan`,
        {
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="bg-slate-50 px-8 py-5 border-b border-slate-200">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Pilih salah satu alasan. Pengajuan ini akan ditinjau oleh Produsen.
                  </p>
                </div>
                    ...
                    {reasonsList.map((reason) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Radio Kustom */}
                          <div
                            className={`w-5 h-5 rounded-full border-2 flex-shrink-0 transition-all ${isSelected ? 'border-emerald-600 bg-white' : 'border-slate-400 bg-white'}`}
                          >
                            {isSelected && (
                          ...
                          <span
                            className={`text-base ${isSelected ? 'font-semibold text-emerald-900' : 'text-slate-700'}`}
                          >
                            {reason}
                          </span>
                        </label>
