...
// Komponen NavItem untuk navigasi tab
        ...
        <main className="pt-16 p-6">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-500">Daftar pesanan yang sudah selesai</p>
            </div>
          </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {pesananData.length > 0 ? pesananData.map((item) => (
                      ...
                      <tr>
                        <td colSpan="6" className="text-center py-10 text-gray-500">Tidak ada pesanan selesai.</td>
                      </tr>
                    )}
                  </tbody>
                </table>
