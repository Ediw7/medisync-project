...
const SidebarApotek = ({
  ...
  const menuItems = [
    ...
    {
      path: "/apotek/stok-obat",
      icon: <FaBoxOpen />,
      label: "Stok Obat",
      description: "Pantau ketersediaan stok",
    },
    {
      path: "/apotek/pesan-obat",
      icon: <FaShoppingCart />,
      label: "Pesan obat",
      description: "Buat pesanan ke PBF",
    },
    {
      path: "/apotek/riwayat-pembelian",
      icon: <FaHistory />,
      ...
      >
        ...
        <div className="relative border-b border-white/10">
          ...
          >
            {!isCollapsed && (
              <div>
                <h3 className="text-xl font-bold tracking-wide">Apotek</h3>
