  ...
  if (isLoading) {
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
        ...
        <p className="mt-4 text-slate-700 font-medium">Memuat Detail Pengembalian...</p>
      </div>
    );
  }
        ...
        <main className="flex-1 overflow-auto pt-[72px] px-12 py-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
              ...
              <div className="p-8">
                <h3 className="text-lg font-bold text-slate-900 mb-6 flex items-center gap-2">
                  <Package size={20} className="text-emerald-600" /> Item dalam Pesanan Ini
                </h3>
              ...
              {pesanan.status === 'Pengembalian Ditolak' && (
                <div className="p-6 bg-red-50 border-t border-red-200 flex flex-col sm:flex-row items-center justify-between gap-4">
