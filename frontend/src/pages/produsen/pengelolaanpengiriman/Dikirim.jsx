              ...
              <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg mt-1">Daftar pesanan yang sedang dalam proses pengiriman</p>
                  </div>
                </div>
                      ...
                      {filteredAndSortedData.length > 0 ? filteredAndSortedData.map((item) => (
                        ...
                        <tr>
                          <td colSpan="7" className="text-center py-10 text-slate-500">
                             ...
                             {searchQuery ? 'Pencarian tidak ditemukan.' : 'Tidak ada pesanan yang sedang dikirim.'}
                          </td>
                        </tr>
                      )}
                    </tbody>
