                        ...
                        <div className="mb-10 relative">
                            ...
                            <div className="relative flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600 text-lg mt-1">Daftar transaksi penjualan ke konsumen.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="min-w-full">
                                    <thead className="bg-slate-50 border-b border-slate-200">
                                        <tr>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">ID Penjualan</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Nama Pelanggan</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Tanggal</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Total Harga</th>
                                            <th className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Apoteker</th>
                                        ...
                                        {filteredData.length > 0 ? filteredData.map((item) => (
                                            <tr key={item.id} className="hover:bg-slate-50 transition-colors">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <span className="text-sm font-mono text-slate-900 bg-slate-100 px-2 py-1 rounded">#{String(item.id).padStart(6, '0')}</span>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-slate-900">{item.nama_pelanggan}</td>
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">{formatDate(item.tanggal_penjualan)}</td>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-600">{item.penanggung_jawab_apoteker}</td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <Link 
                                            ...
                                            <tr>
                                                <td colSpan="6" className="text-center py-12">
                                                    ...
                                                    <p className="text-slate-500 font-medium">
                                                        {searchTerm ? "Tidak ada riwayat yang sesuai." : "Belum ada riwayat penjualan."}
                                                    </p>
                                                </td>
                                            </tr>
                                        )}
