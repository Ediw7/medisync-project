...
const DibatalkanApotek = () => {
  ...
  // Filter Halaman Ini - mencakup kedua status pembatalan
  const relevantStatuses = ['Dibatalkan', 'Pembatalan Diajukan'];
