    ...
    >
      ...
      >
        ...
        <p className="text-slate-700 mb-6 leading-relaxed">
          ...
          <strong className="font-mono">#{String(orderId).padStart(6, '0')}</strong>? Tindakan ini
          akan mengarsipkan pesanan.
        </p>
...
const PesanObatApotek = () => {
  ...
  const handleConfirmSelesai = () => {
    ...
    setPesananData((prevData) =>
      prevData.map((item) => (item.id === selectedOrderId ? { ...item, status: 'Selesai' } : item))
    );
  };
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg mt-1">
                      Kelola riwayat pesanan Anda ke PBF.
                    </p>
                  </div>
                </div>
                <button
                        ...
                        <div className="absolute right-0 mt-2 w-72 bg-white p-4 rounded-lg shadow-xl z-20 border border-slate-200">
                          ...
                          <div className="flex justify-end gap-2 mt-4">
                            <button
                              ...
                              className="text-xs font-medium text-slate-600 hover:text-red-600 px-3 py-1 rounded-md hover:bg-red-50"
                            >
                              Reset
                            </button>
                            <button
