...
const DetailPesananApotek = () => {
  ...
  const alasanPembatalan =
    pesanan.catatan_khusus?.split('Alasan:')[1]?.split('\n')[0]?.trim() || null;
              ...
              <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <InfoItem
                    icon={DollarSign}
                    label="Total Harga"
                    value={`Rp ${Number(pesanan.total_harga || 0).toLocaleString('id-ID', { minimumFractionDigits: 2 })}`}
                    highlight
                  />
                </div>
              </div>
