...
const ConfirmModal = ({ show, onClose, onConfirm, isLoading, pesanan }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white p-8 rounded-xl shadow-2xl max-w-sm w-full mx-auto border border-slate-200"
      ...
      >
        ...
        <p className="text-slate-700 mb-6 leading-relaxed">
          ...
          ke <strong>{pesanan?.nama_pbf}</strong>?
          <br />
          <br />
        ...
        <div className="flex justify-end gap-3">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="px-6 py-2.5 font-medium rounded-lg bg-slate-100 text-slate-700 hover:bg-slate-200 disabled:opacity-50"
          >
            Batal
          </button>
          <button
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-6 py-2.5 font-medium rounded-lg flex items-center gap-2 ${isLoading ? 'bg-slate-400 text-white' : 'bg-emerald-600 text-white hover:bg-emerald-700'}`}
          >
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          const response = await axios.get(
            `http://localhost:5000/api/produsen/pesanan-masuk/${id}`,
            {
  ...
  const handleConfirmSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://localhost:5000/api/produsen/pesanan-masuk/${id}/status`,
        {
          status: 'Dikirim',
          nomorResi,
          nomorSuratJalan,
          ...
          <main className="flex-1 p-8 flex items-center justify-center">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-red-200 text-center">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 border border-slate-300 text-slate-700 font-medium rounded-lg hover:bg-slate-100 mx-auto"
              >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-10 relative">
              ...
              <div className="relative">
                <button
                  onClick={() => navigate(-1)}
                  className="mb-4 inline-flex items-center text-emerald-600 hover:text-emerald-700 text-sm font-medium"
                >
