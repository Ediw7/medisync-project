...
import {
  ...
  AlertTriangle,
  Calendar,
  CheckCircle2, // Ikon untuk header
} from 'lucide-react';
import { toast } from 'react-hot-toast';

// Komponen nav item untuk handle state aktif (Gaya "Pill")
...
const Selesai = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const filteredData = (result.data || []).filter((item) => item.status === 'Selesai');
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-lg mt-1">
                      Daftar pesanan yang telah selesai terkirim.
                    </p>
                  </div>
                </div>
              </div>
