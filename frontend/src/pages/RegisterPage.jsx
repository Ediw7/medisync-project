...
function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        'Registrasi berhasil. Akun Anda akan segera diverifikasi oleh admin sebelum bisa digunakan untuk login.'
      );
      navigate(`/login/${role}`);
    } catch (error) {
  ...
  const displayRole =
    role === 'pbf' ? role.toUpperCase() : role.charAt(0).toUpperCase() + role.slice(1);
    ...
    <div className="min-h-screen bg-gray-200/90 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-white/10 backdrop-blur-2xl rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden border border-white/30 backdrop-saturate-150">
        ...
        <div className="hidden md:flex flex-col justify-center p-10 bg-gradient-to-br from-emerald-600/90 to-[#047857] text-white backdrop-blur-xl border-r border-white/20">
          ...
          <p className="text-[#F9FDFE] mb-10">
            Daftarkan entitas Anda untuk menjadi bagian dari ekosistem rantai pasok farmasi yang
            transparan dan aman.
          </p>
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-text-[#F9FDFE]">
                  Setiap peserta di jaringan akan diverifikasi untuk menjamin kepercayaan.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-text-[#F9FDFE]">
                  Lakukan pemesanan dan pengiriman dalam satu platform yang terhubung.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-text-[#F9FDFE]">
                  Sistem dirancang untuk membantu memenuhi standar regulasi farmasi.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-gray-700 border-b pb-2">
                Informasi Perusahaan / Apotek
              </h3>
              <InputField
                name="namaResmi"
                placeholder="Nama Resmi Sesuai Izin"
                icon={<Building size={18} />}
                value={form.namaResmi}
                onChange={handleChange}
              />
              <InputField
                name="nomorIzin"
                placeholder={izinLabel[role]}
              ...
              <InputField
                name="alamat"
                placeholder="Alamat Lengkap Sesuai Izin"
                icon={<MapPin size={18} />}
                value={form.alamat}
                onChange={handleChange}
              />
            ...
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-gray-700 border-b pb-2 pt-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500"
                />
                <button
                  type="button"
            ...
            <div className="pt-4">
              <button
                ...
                className="w-full bg-emerald-600 text-white py-3 rounded-lg hover:bg-emerald-700 font-semibold transition-all duration-300 text-lg shadow-lg hover:shadow-emerald-200 disabled:bg-gray-400 flex items-center justify-center"
              >
