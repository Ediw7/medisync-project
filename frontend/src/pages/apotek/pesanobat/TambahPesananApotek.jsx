                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
                        ...
                        <div className="mb-6 md:mb-8">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 md:p-6">
                                ...
                                <p className="text-sm md:text-base text-slate-600">
                                    Lengkapi detail pesanan Anda ke <span className="font-semibold text-emerald-700">{pbfInfo.namaPbf}</span>
                                </p>
                            </div>
                        </div>
                        ...
                        {error && (
                          <div className="p-4 mb-6 bg-red-50 text-red-700 rounded-xl border border-red-200 text-sm font-medium flex items-start gap-3 shadow-sm">
                            ...
                            <button onClick={() => setError('')} className="flex-shrink-0 hover:bg-red-100 rounded p-1">
                                <X size={16} />
                            </button>
                          </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="p-4 md:p-6 border-t border-slate-200 bg-slate-50/50">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 md:gap-4">
                                        <div className="sm:col-span-2 lg:col-span-5">
                                            <label className="block text-xs md:text-sm font-medium text-slate-700 mb-1.5">Pilih Obat</label>
                                            <select
                                                name="id"
                                                value={itemObat.id || ''}
                                        ...
                                        <div className="lg:col-span-3">
                                            <label className="block text-xs md:text-sm font-medium text-slate-700 mb-1.5">Harga Satuan</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="sm:col-span-2 lg:col-span-2">
                                            <label className="block text-xs md:text-sm font-medium text-slate-700 mb-1.5 opacity-0">Action</label>
                                            <button 
                                                type="button" 
                            ...
                            <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4 sticky bottom-0 bg-gradient-to-t from-slate-50 via-slate-50 to-transparent pb-4">
                                ...
                                >
                                  {isSubmitting ? <Loader2 className="animate-spin" size={18}/> : <Package size={18} />}
