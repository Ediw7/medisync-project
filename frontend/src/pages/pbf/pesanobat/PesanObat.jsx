      ...
      <div className="bg-white p-6 rounded-2xl shadow-xl max-w-sm w-full">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-end gap-4">
            <button
              onClick={onClose}
              className="py-2 px-4 bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-colors"
            >
              Batal
            </button>
            <button
...
const PesanObat = () => {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'Perlu Dikirim': return 'bg-amber-50 text-amber-700 border-amber-200';
            ...
            <div className="mb-10 relative">
              ...
              <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button
                  ...
                  className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white font-medium py-2.5 px-5 rounded-lg hover:shadow-lg transition-all flex items-center gap-2 shadow-sm whitespace-nowrap w-full sm:w-auto justify-center"
                >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-between pl-10 pr-4 py-2 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 hover:bg-slate-50 transition-colors"
                    >
                      ...
                      <div className="absolute right-0 mt-2 w-80 bg-white p-4 rounded-xl shadow-xl z-20 border border-slate-200">
                        ...
                        <div className="flex gap-2 mb-3">
                          <button 
                            ...
                            className="text-xs border border-slate-300 px-3 py-1.5 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-700 transition-colors"
                          >
                            7 Hari Terakhir
                          </button>
                          <button 
                        ...
                        <button
                          ...
                          className="w-full py-2 bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-lg text-sm hover:shadow-lg transition-all"
                        >
                          Terapkan
                        </button>
                      </div>
                ...
                <table className="min-w-full">
                  <thead className="bg-slate-50 border-b-2 border-slate-200">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">PBF</th>
                      <th className="px-6 py-3 text-left text-xs font-bold text-slate-600 uppercase tracking-wider">Alamat Pengiriman</th>
                    ...
                    {filteredData.length > 0 ? (
                      filteredData.map((item) => (
                        <tr key={item.id} className="hover:bg-emerald-50/30 transition-colors">
                          ...
                          <td className="px-6 py-4 text-sm text-slate-600 max-w-xs truncate">{item.alamat_pbf}</td>
