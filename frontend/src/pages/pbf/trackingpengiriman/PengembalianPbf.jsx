  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setPesananList(response.data.data.filter((p) => statusFilter.includes(p.status)));
      } else {
  ...
  const getStatusClass = (status) => {
    switch (status) {
      ...
      case 'Pengembalian Disetujui':
        return 'bg-purple-100 text-purple-800 border border-purple-200'; // Ditambahkan
      case 'Dikembalikan':
  ...
  if (isLoading && pesananList.length === 0) {
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
        ...
        <p className="mt-4 text-slate-700 font-medium">Memuat Data Pengembalian...</p>
      </div>
    );
  }
              ...
              <div className="relative flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-lg mt-1">
                    Lacak semua pengembalian masuk dari apotek.
                  </p>
                </div>
              </div>
            </div>
                      ...
                      <tr>
                        ...
                        >
                          <div className="flex items-center gap-1">
                            Apotek Tujuan {getSortIndicator('nama_apotek')}
                          </div>
                        </th>
                        <th
                          className="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider cursor-pointer hover:bg-slate-100"
                        ...
                        <tr>
                          <td colSpan="6" className="text-center py-10 text-slate-500">
                            ...
                            {searchTerm
                              ...
                              : 'Tidak ada pengembalian dalam kategori ini.'}
                          </td>
                        </tr>
                      )}
                    </tbody>
...
export default PengembalianPbf;
