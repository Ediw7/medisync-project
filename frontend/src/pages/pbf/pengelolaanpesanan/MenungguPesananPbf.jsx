...
const NavItem = ({ label, to }) => {
  ...
  // Cek path URL, bukan state filter
...
const MenungguPesananPbf = () => {
  ...
  const statusFilter = 'Menunggu Konfirmasi'; // Filter di-hardcode
  ...
  if (isLoading && pesananList.length === 0) {
     return (
       <div className="flex flex-col justify-center items-center h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50">
          ...
          <p className="mt-4 text-slate-700 font-medium">Memuat Pesanan Menunggu Konfirmasi...</p>
      </div>
    );
  }
            ...
            <div className="mb-10 relative">
              ...
              <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button 
                  ...
                  className="relative z-20 bg-emerald-600 text-white font-medium py-2.5 px-5 rounded-lg hover:bg-emerald-700 transition flex items-center gap-2 shadow-sm whitespace-nowrap w-full sm:w-auto justify-center"
                >
                      ...
                      {filteredAndSortedData.length > 0 ? filteredAndSortedData.map((order) => (
                        ...
                        <tr>
                          <td colSpan="7" className="text-center py-10 text-slate-500">
                            ...
                            {searchTerm ? 'Tidak ada pesanan yang cocok.' : 'Tidak ada pesanan menunggu konfirmasi.'}
                          </td>
                        </tr>
                      )}
                    </tbody>
...
export default MenungguPesananPbf;
