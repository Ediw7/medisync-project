    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/api/pbf/pesanan-apotek/${id}/surat-jalan`,
          {
  ...
  const handleKirimKeBlockchain = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/pbf/pesanan-apotek/${id}/record-to-blockchain`,
        {
          method: 'POST',
          headers: {
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-2xl font-bold text-slate-800">
                      {info.nama_pbf || 'Nama PBF'}
                    </h1>
                    <p className="text-xs text-slate-600 max-w-xs">
                      {info.alamat_pbf || 'Alamat PBF'}
                    </p>
                  </div>
                </div>
