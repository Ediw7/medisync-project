export function AnimatedBackground() {
  return (
    <>
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-[#047857]/30 rounded-full blur-3xl animate-float-1"></div>
      ...
      <div
        className="absolute bottom-0 right-0 w-96 h-96 bg-[#047857]/40 rounded-full blur-3xl animate-float-4"
        style={{ animationDelay: '2s' }}
      ></div>

      <div
        className="absolute top-1/2 left-1/4 w-64 h-64 bg-blue-200/20 rounded-full blur-2xl animate-float-5"
        style={{ animationDelay: '1s' }}
      ></div>

      <div
        className="absolute bottom-1/4 left-1/2 w-48 h-48 bg-purple-200/20 rounded-full blur-2xl animate-float-6"
        style={{ animationDelay: '3s' }}
      ></div>

      <div
        className="absolute top-1/3 right-1/4 w-80 h-80 bg-pink-200/40 rounded-full blur-3xl animate-float-1"
        style={{ animationDelay: '0.5s' }}
      ></div>

      <div
        className="absolute bottom-1/3 left-1/3 w-56 h-56 bg-orange-200/50 rounded-full blur-2xl animate-float-2"
        style={{ animationDelay: '1.5s' }}
      ></div>

      <div
        className="absolute top-2/3 left-3/4 w-72 h-72 bg-yellow-200/30 rounded-full blur-3xl animate-float-3"
