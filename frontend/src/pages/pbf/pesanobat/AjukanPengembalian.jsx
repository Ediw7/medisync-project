...
import { Upload, AlertCircle, Loader2, ArrowLeft, FileText, Package, X } from 'lucide-react';
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="bg-slate-50 px-8 py-5 border-b border-slate-200">
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Isi detail alasan dan unggah bukti foto yang jelas.
                  </p>
                </div>
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">
                      Jelaskan mengapa Anda ingin mengembalikan barang (misal: barang rusak, jumlah
                      tidak sesuai, salah kirim).
                    </p>
                  </div>
                        ...
                        {previewFoto ? (
                          ...
                          <div className="text-center text-slate-500">
                            ...
                            <p className="mt-2 text-sm font-medium">
                              Klik untuk <span className="text-emerald-600">unggah file</span>
                            </p>
