    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `http://localhost:5000/api/apotek/pesanan/riwayat/${assetId}`,
          {
              ...
              <div className="bg-gradient-to-r from-emerald-500 to-teal-600 px-6 py-5 border-b border-slate-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                <div>
                  ...
                  <p className="text-sm text-emerald-50 mt-1">
                    Status penerimaan untuk Aset ID: <span className="font-mono">{assetId}</span>
                  </p>
                </div>
                <div
              ...
              <div className="p-8 py-12">
                ...
                <div className="flex items-start justify-center gap-0">
                  <StatusStep
                    ...
                    isCompleted={isDipesanCompleted}
