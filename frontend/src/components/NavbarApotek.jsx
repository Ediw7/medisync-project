...
const NavbarApotek = ({ onLogout, onToggleSidebar }) => {
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden lg:block text-left">
                <p className="text-sm font-medium text-gray-800">{username || 'Apotek'}</p>
                <p className="text-xs text-gray-500">Pengelola Apotek</p>
              </div>
            </button>
