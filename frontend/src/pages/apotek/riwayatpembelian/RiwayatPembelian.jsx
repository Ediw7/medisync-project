...
const RiwayatPembelian = () => {
    ...
    const filteredData = useMemo(() => {
        ...
        const relevantStatuses = ['Selesai', 'Dibatalkan', 'Pengembalian Selesai', 'Pengembalian Ditolak'];
    ...
    const getStatusBadge = (status) => {
        switch (status) {
            ...
            case 'Pengembalian Ditolak': return 'bg-pink-100 text-pink-800 border border-pink-200';
    ...
    const renderAction = (item) => {
        ...
        return (
            <Link 
                ...
                className={`${baseClasses} ${detailClasses}`}
            >
                            ...
                            <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 text-lg mt-1">Melihat riwayat pesanan yang telah selesai atau dibatalkan.</p>
                                    </div>
                                </div>
                                <button
